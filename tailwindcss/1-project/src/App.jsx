    ...
    <>
      <div className="max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto">
        <div className="relative">
          ...
          <button className="absolute top-2 right-2 text-gray-500 hover:text-red-500 transition-all duration-300">
          ...
          <div className="p-4">
            {/* line-clamp-1 表示只显示一行 超出的部分省略号表示 */}
            <h3 className="text-lg font-semibold text-gray-800 line-clamp-1">
              这是一个商品标题, 这是一个商品标题, 这是一个商品标题,
              这是一个商品标题,
            </h3>
            <p className="text-sm text-gray-500 mt-1 line-clamp-2">
              商品描述, 商品描述, 商品描述, 商品描述, 商品描述, 商品描述,
              商品描述,
            </p>
